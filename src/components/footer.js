  ...
  return (
    ...
    <div className="text-center">
            ...
            <div className="flex justify-center my-10">
                <div className="flex items-center  w-auto  hover:font-medium border rounded-lg px-4 py-2 w-52 mx-2">
                ...
                <div className="flex items-center border hover:font-medium w-auto rounded-lg px-4 py-2 w-44 mx-2">
