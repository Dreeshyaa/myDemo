    ...
    return(
        ...
        <div className="flex flex-wrap  bg-white justify-center ">
            ...
            <div className=" mt-4 ml-12 max-w-2xl shadow-lg">
                <h2 className="text-center font-semibold">Contact Us</h2>
                <div className="p-4">
                <div>
              ...
              <input type="email" id="email" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
               ...
               dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="name@gmail.com"
                required/>
                </div>
                <div>
              ...
              shadow-sm focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
               dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"
                ...
                <button type="submit" class="mt-4 py-3 px-5 text-sm font-medium text-center hover:text-white rounded-lg nav-color3 sm:w-fit
                 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 
                 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
                </div>
            </div>
              </div>
              <div className="w-full sm:w-1/2 md:w-1/4">
                  <div className="  mt-4 ml-12 max-w-xl shadow-lg py-24 p-12">
